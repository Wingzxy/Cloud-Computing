...
def create_ec2_instance(image_id, instance_type, keypair_name, GroupName, instancenumber):
    ...
    try:
        response = ec2.create_instances(ImageId=image_id,
                                            ...
                                            MinCount=instancenumber,
                                            MaxCount=instancenumber,
                                            UserData=startup)
...
def upload2(zeros, ranges, p_num):
    ...
    for current_range in range(instance_number):
        ...
        print(instance_info[current_range])
        ...
        ip = instance_info[current_range].public_ip_address
