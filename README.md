...
- If init_B returns 'Didn't receive any message', please increase the sleep time, it's because boto3 and pip didn't finish installing, it used to takes aournd 90s, but sometime is much more!
